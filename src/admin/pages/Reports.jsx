    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-white p-4 rounded-lg shadow-md flex text-center">
                    <img src="https://cdn-icons-png.flaticon.com/512/18549/18549289.png" alt="salesicon" className="w-16 h-16 m-4"/>
                ...
                <div className="bg-white p-4 rounded-lg shadow-md flex text-center">
                    <img src="https://cdn-icons-png.flaticon.com/512/3502/3502601.png" alt="ordericon" className="w-16 h-16 m-4" />
                    <div className="w-full m-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-md flex text-center">
                    <img src="https://cdn-icons-png.flaticon.com/512/11695/11695593.png" alt="usericon" className="w-16 h-16 m-4" />
                    <div className="w-full m-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-md flex">
                    <img src="https://cdn-icons-png.flaticon.com/512/12072/12072210.png" alt="statusicon" className="w-16 h-16 m-4"/>
